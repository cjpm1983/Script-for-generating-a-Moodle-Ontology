...
if len(sys.argv) > 1 :
     ...
     #if os.path.exists("/home/ubuntu/scriptontlogias/config.yml"):
     #      with open("/home/ubuntu/scriptontlogias/config.yml","r") as ymlfile:
...
with open('moodle.csv', 'w', newline='') as csvfile:
    ...
    try:
        ...
        if connection.is_connected():
            ...
            #sql = "SELECT U.id as id FROM mdl_user_info_data as CF , mdl_user as U WHERE CF.data like '____-____-____-____' AND CF.fieldid={} AN>
            ...
            for id_usuario in tqdm(ids_usuarios): 
                ...
                if i>-1:
                    ...
                    if len(cursos) != 0: 
                        ...
                        if ( orcid != '0000-0000-0000-0000' and re.search('(\d{4}\-\d{4}\-\d{4}\-\d{3}(?:\d|X))', orcid) ) :
                            iusuario = {
                                            "uid" : id_usuario, 
                                            "username" : cursos[0][0] ,
                                            "firstname" : cursos[0][1] ,
                                            "lastname" : cursos[0][2] ,
                                            "email" : cursos[0][3] ,
                                            "city" : cursos[0][4] ,
                                            "country" : cursos[0][5] ,
                                            "institution" : cursos[0][6] ,
                                            "department" : cursos[0][7] ,
                                            "phone1" : cursos[0][8] ,
                                            "orcid" : orcid ,
